# Analysis-of-Amazon-Health-and-Personal-Care-Product-Reviews-for-Customer-Satisfaction
This is a group data analysis project from class BA820 (Unsupervised and Unstructured Machine Learning), spring 2025. Members include Jyun-Ru Huang, Pin-Hao Pan, Ruo-Rong Wang, and myself.

This project analyzes customer reviews from the Amazon Health and Personal Care category to uncover trends, customer behaviors, and sentiment patterns using exploratory data analysis, text processing, unsupervised clustering, and sentiment classification. We also used topic modeling (LDA) method to address gaps in our dataset. 
